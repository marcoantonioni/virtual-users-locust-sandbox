...
class BpmEnvironment:
    ...
    keyBAW_UNIT_TEST_SCENARIO_OUT_FILE_NAME : str = "BAW_UNIT_TEST_SCENARIO_OUT_FILE_NAME"
    keyBAW_UNIT_TEST_SCENARIO_OUT_SQLITEDB_NAME : str = "BAW_UNIT_TEST_SCENARIO_OUT_SQLITEDB_NAME"
    keyBAW_UNIT_TEST_SCENARIO_OUT_USEDB : str = "BAW_UNIT_TEST_SCENARIO_OUT_USEDB"
